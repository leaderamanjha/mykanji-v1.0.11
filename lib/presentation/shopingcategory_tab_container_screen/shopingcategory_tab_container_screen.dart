...
class ShopingcategoryTabContainerScreen
  ...
  const ShopingcategoryTabContainerScreen({Key? key}) : super(key: key);
                          ...
                          tabs: [
                            ...
                            Tab(
                                child: CustomOutlinedButton(
                                    ...
                                    buttonStyle:
                                        CustomButtonStyles.outlineGrayLR8,
                                    buttonTextStyle:
                                        CustomTextStyles.titleSmallGray90003))
                          ])),
                  Expanded(
                      child: SizedBox(
                          height: 938.v,
  ...
  PreferredSizeWidget _buildAppBar() {
    return CustomAppBar(
        ...
        title: AppbarSubtitleTwo(
            text: "lbl_koramangala".tr, margin: EdgeInsets.only(left: 16.h)),
        actions: [
          AppbarTrailingImage(
              imagePath: ImageConstant.imgSearchBlack900,
              margin: EdgeInsets.only(left: 16.h, top: 20.v, right: 20.h)),
          AppbarTrailingImage(
              imagePath: ImageConstant.imgNotification,
              margin: EdgeInsets.only(left: 28.h, top: 20.v, right: 20.h),
              onTap: () {
                onTapNotification();
              }),
          AppbarTrailingImage(
              imagePath: ImageConstant.imgLock,
              margin: EdgeInsets.only(left: 28.h, top: 20.v, right: 36.h))
        ],
