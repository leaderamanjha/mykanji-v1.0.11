...
class OngoingOrderOneScreen extends GetWidget<OngoingOrderOneController> {
  const OngoingOrderOneScreen({Key? key}) : super(key: key);
  ...
  PreferredSizeWidget _buildAppBar() {
    return CustomAppBar(
        ...
        centerTitle: true,
        title: AppbarSubtitleOne(text: "lbl_ongoing_order".tr),
  ...
  Widget _buildOrderStatus() {
    return Container(
        ...
        child: Column(children: [
          ...
          SizedBox(height: 28.v),
          _buildOrderAcceptedRejected(
              headlineText: "lbl_order_placed".tr, dateText: "lbl_date".tr),
    ...
    return Container(
        ...
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          CustomDropDown(
              ...
              items: controller
                  .ongoingOrderOneModelObj.value.dropdownItemList.value,
              onChanged: (value) {
  ...
  /// Common widget
  Widget _buildOrderAcceptedRejected({
